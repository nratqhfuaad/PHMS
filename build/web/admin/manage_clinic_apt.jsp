...
<html lang="en">
    <head>
        ...
        <title>PHMS | Admin | Health Clinic Appointment</title>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="content-header">
                        <div class="container-fluid">
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    <h1 class="m-0">Health Clinic Appointment List <%= msg%></h1>
                            </div>
                            <!-- /.col -->
<!--                            <div class="col-sm-6">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="input-group">
                                <form class="input-group" action="ManageClinicApt" method="post">
                                    <input placeholder="Booking ID" class="form-control" type="text" id="bookingID" name="bookingID" readonly="">
                                    <input placeholder="Full Name" class="form-control" type="text" id="BFullName" name="BFullName" readonly="">
                                    <input placeholder="Appointment Date" class="form-control" type="text" id="BDate" name="BDate" readonly="">
                                    <input placeholder="Appointment Time" class="form-control" type="text" id="BTime" name="BTime" readonly="">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <table class="col-lg-12 table table-responsive" id="tableID">
                                    <thead>
                                        <tr>
                                            <th class="header__item"><button id="bookID" class="filter__link filter__link--number"><b> Booking ID</b></button></th>
                                            <th>First Name</th>
                                            <th>Last Name</th>
                                            <th>Contact Number</th>
                                            <th>NRIC / Passport No.</th>
                                            <th>Gender</th>                                           
                                            <th><button id="bookDate" class="filter__link filter__link--number" ><b>Appointment Date</b></button>
                                    ...
                                    <tbody class="table-content">
                                        <c:forEach var="table" items="${rs.rows}">  
                                            <tr class="table-row ">  
                                                <td class="table-data"><c:out value="${table.bookingID}"/></td>  
                                                <td class="table-data"><c:out value="${table.BFName}"/></td>  
                                                <td class="table-data"><c:out value="${table.BLName}"/></td>  
                                                <td class="table-data"><c:out value="${table.BContactNo}"/></td>  
                                                <td class="table-data"><c:out value="${table.BIC}"/></td>
                                                <td class="table-data"><c:out value="${table.BGender}"/></td>
                                                <td class="table-data"><c:out value="${table.BDate}"/></td>
                                                <td class="table-data"><c:out value="${table.BTime}"/></td>
                                                <td class="table-data"><c:out value="${table.BDesc}"/></td>
                                                <td id='<c:out value="${table.BStatus}"/>' class="table-data"><c:out value="${table.BStatus}"/></td>
                                            </tr>  
                                        </c:forEach>  
                                    </tbody>
                                </table>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                function populateFields(row) {
                    el('bookingID').value = row.cells[0].innerHTML;
                    el('BFullName').value = row.cells[1].innerHTML + " " + row.cells[2].innerHTML;
                    el('BDate').value = row.cells[6].innerHTML;
                    el('BTime').value = row.cells[7].innerHTML;
                }
        ...
        <script>
            ...
            $("#bookDate").on("click", function (e) {
                ...
                $('#tableID tbody tr').sort(function (a, b) {
                    var aval = new Date($(a).find('td:eq(6)').text()).getTime();
                    var bval = new Date($(b).find('td:eq(6)').text()).getTime();
