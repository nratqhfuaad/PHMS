...
<html lang="en">
    <head>
        ...
        <title>PHMS | Admin | Update News Feed</title>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="content-header">
                        <div class="container-fluid">
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    <h1 class="m-0">Update News Feed</h1>
                                </div>
                                <!-- /.col -->
                                <div class="col-sm-6">
                    ...
                    <section class="content">
                        <div class="container-fluid">
                            ...
                            <div class="container">
<!--                                    -->
                                    <form action="UpdateNews" method="post"><br>
                                        <input class="form-control" type="number" placeholder="newsID" id="newsID" name="newsID" hidden ><br>
                                        
                                        <label for="newsTitle" class="col-sm-2 col-form-label">News Title:</label>
                                        <input class="form-control" type="text" placeholder="News Title" id="newsTitle" name="newsTitle" value="" required><br>
                                        
                                        <label for="newsContent" class="col-sm-2 col-form-label">News Content:</label>
                                        <textarea class="form-control" aria-label="With textarea" placeholder="News Content" id="newsContent" name="newsContent" value="" required></textarea><br>
                                        
                                        <label for="newsDate" class="col-sm-2 col-form-label">News Date:</label>
                                        <div class="col-md-3 mb-3">
                                        <input class="form-control" type="date" id="newsDate" name="newsDate" value="" required></div><br>
                                        
                                        <center><input class="btn btn-primary" type="submit" value="Update News"><br><br></center>
                                    </form>
